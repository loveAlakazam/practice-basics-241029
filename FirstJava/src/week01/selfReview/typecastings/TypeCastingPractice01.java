...
public class TypeCastingPractice01 {
    public static void main( String[] args ) {
        ...
        System.out.println( "short -> int: " + intDish );

        // 자동 캐스팅 2.int -> long
        long longDish;
        intDish = 2147483647;
        longDish = intDish;
        System.out.println( "int -> long: " + longDish );

        // 자동 캐스팅 3. long -> float
        longDish = 21474836489L;
        float floatDish = longDish;
        System.out.println( "long -> float: " + floatDish );

        // 자동 캐스팅 4. float -> double
        floatDish = 3.1415921753f;
        double doubleDish = floatDish;
        System.out.println( "float -> double: " + doubleDish );
    }
}
